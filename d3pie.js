...
(function(root, factory) {
    ...
    var segments = {
        ...
        openSegment: function(pie, segment) {
            ...
            segments.maybeCloseOpenSegmentWithPrefix(pie.cssPrefix);
        ...
        maybeCloseOpenSegmentWithPrefix: function(cssPrefix) {
            console.log(("." + cssPrefix + "expanded"));
            if (d3.selectAll("." + cssPrefix + "expanded").size() > 0) {
                console.log("maybe close");
                segments.closeSegment(pie, d3.select("." + cssPrefix + "expanded").node());
            }
        },

        maybeCloseOpenSegment: function() {
            //console.log(("." + pie.cssPrefix + "expanded"));
